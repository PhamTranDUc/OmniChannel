...
public interface UserService {
     ...
     *
     * @param id The email address of the user to be found.
     * @return ResponseEntity containing an ApiResponse with the user information if found.
     */
//    ResponseEntity<ApiResponse> findUserById(String id);
     ...
     */
    ResponseEntity<ApiResponse> findAllUsersExceptThisUserId(String userId);
     ...
     */
    ResponseEntity<ApiResponse> findConversationIdByUser1IdAndUser2Id(String user1Id, String user2Id);
}
