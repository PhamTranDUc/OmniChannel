...
//        }
     ...
     */
    @Override
    public ResponseEntity<ApiResponse> findAllUsersExceptThisUserId(String userId) {
     ...
     */
    @Override
    public ResponseEntity<ApiResponse> findConversationIdByUser1IdAndUser2Id(String user1Id, String user2Id) {
        int conversationId;
