...
export class AuthComponent {
  ...
  onUserRegister(): void {
    let body: User = {
      ...
      // email: this.email,
      id: this.name, // Update the reference to the variable to match the template change
      name: this.name, // Update the reference to the variable to match the template change
    };
